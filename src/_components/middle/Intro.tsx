...
import greetingsIcon from '@/app/assets/images/greets.png'
  ...
  return (
    <div className={styles.mainContainer}>
        <div className={styles.introContainer}>
            <div className={styles.innerContainer}>
                <div className='flex flex-row gap-2 items-center'>
                    ...
                    <Image alt='greeting emoji' src={greetingsIcon} height={35}/>
                </div>
                <DateComponent />
            </div>
        ...
        <div className={styles.introMetricsContainer}>
            <div className={styles.innerMetricsContainer1}>
                ...
                <div className='flex flex-col items-center'>
                    <p className={styles.metricsTitle}>Interactions</p>
                    <p>5,000</p>
                </div>
            </div>

            <div className={styles.innerMetricsContainer2}>
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width='30' height='30'>
                ...
                <div className='flex flex-col items-center'>
                    <p className={styles.metricsTitle}>Progress</p>
                    <p>40%</p>
                </div>
            </div>

            <div className={styles.innerMetricsContainer3}>
            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="30" height="30">
                ...
                <div className='flex flex-col items-center'>
                    <p className={styles.metricsTitle}>Efficiency</p>
                    <p>95%</p>
                </div>
            </div>
        </div>
