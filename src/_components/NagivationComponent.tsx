...
const NagivationComponent = () => {
  ...
  return (
    <>
        <div className={styles.topContainer}>
            ...
            <div className={styles.navIconSubContainers}>
                <div className={styles.navIcons}>
                    <div className={styles.iconContainer} onClick={()=> handlePageNavigation('home')}>
                    ...
                    <div className={styles.iconContainer} onClick={()=> handlePageNavigation('settings')}>
        ...
        <div className={styles.navIcons}>
            <div className={styles.iconContainer} onClick={()=> handlePageNavigation('help')}>
                <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20">
